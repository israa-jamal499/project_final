...
<main class="student-page dashboard-page">
    ...
    <section class="dashboard-hero white-card">
        <div class="dashboard-hero-content">
            <div class="hero-text">
                <span class="hero-badge badge badge-success">التدريب نشط</span>
            ...
            <div class="hero-progress-card">
                ...
                <p>تم اعتماد 82 ساعة من أصل 120 ساعة مطلوبة</p>
            </div>
        </div>
    </section>
    ...
    <section class="dashboard-stats">
        ...
        <article class="stat-card white-card">
            ...
            <div class="stat-info">
                <h3>التقارير</h3>
                <strong>6</strong>
                <span>آخر تقرير قيد المراجعة</span>
            </div>
        </article>
            ...
            <article class="dashboard-card white-card">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <strong>م. سارة عوض</strong>
                    </div>

                    <div class="info-item">
                        <span class="label">حالة التدريب</span>
                        <strong class="text-success">مستمر</strong>
                    </div>
...
<!-- Hours Progress -->
            ...
            <article class="dashboard-card white-card">
                <div class="card-head">
                    <h3>🎓 حالة الشهادة</h3>
                    <a href="{{ route('front.student.certificate') }}">عرض الشهادة</a>
                </div>
            ...
            <article class="dashboard-card white-card">
                ...
                <div class="simple-table-wrap">
                    <table class="clean-table">
                        ...
                        <tbody>
                            <tr>
                                <td>الأسبوع السادس</td>
                                <td>متابعة مهام الواجهة الأمامية</td>
                                <td>2026-04-05</td>
                                <td><span class="badge badge-warning">قيد المراجعة</span></td>
                            </tr>
                            <tr>
                                <td>الأسبوع الخامس</td>
                                <td>تحسين تصميم صفحة الفرص</td>
                                <td>2026-03-29</td>
                                <td><span class="badge badge-success">مقبول</span></td>
                            </tr>
                            <tr>
                                <td>الأسبوع الرابع</td>
                                <td>ربط واجهات الطالب</td>
                                <td>2026-03-22</td>
                                <td><span class="badge badge-success">مقبول</span></td>
                            </tr>
                        </tbody>
        ...
        <aside class="dashboard-side-column">
            ...
            <article class="dashboard-card white-card">
                ...
                <div class="quick-actions">
                    ...
                    {{-- <a href="{{ route('front/student.front.student.massege') }}" class="quick-action"> --}}
                        <span class="quick-icon">💬</span>
                        <div>
            ...
            <article class="dashboard-card white-card">
                ...
                <ul class="details-list">
                    <li><span>البريد الإلكتروني</span><strong>ahmad@ucas.edu.ps</strong></li>
                    <li><span>رقم التواصل</span><strong>0590000000</strong></li>
                    <li><span>القسم</span><strong>هندسة أمن المعلومات</strong></li>
                </ul>
            </article>
            ...
            <article class="dashboard-card white-card">
                ...
                <div class="mini-notifications">
                    <div class="mini-notification">
                        ...
                        <div>
                            <strong>تمت مراجعة تقريرك الأخير</strong>
                    ...
                    <div class="mini-notification">
                        ...
                        <div>
                            <strong>تم اعتماد 8 ساعات تدريب</strong>
                            <small>أمس</small>
                        </div>
                    </div>
                    ...
                    <div class="mini-notification">
                        ...
                        <div>
                            <strong>لديك رسالة جديدة من المشرف</strong>
