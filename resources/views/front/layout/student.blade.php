...
<body>
    ...
    @php
        ...
        $studentId   = $studentId ?? '202200000';
        $studentAvatar = $studentAvatar ?? asset('internship/img/default-avatar.png');
    @endphp
            ...
            <div class="topbar-left">
                ...
                <div class="student-profile-wrapper">
                    ...
                    <div class="student-dropdown" id="studentDropdown">
                        <a href="{{ route('front.student.profile') }}">👤 ملفي الشخصي</a>
                        <a href="{{ route('front.student.applications') }}">📌 طلباتي</a>
                        <a href="{{ route('front.student.internship') }}">🏢 ملف التدريب</a>
                        <a href="{{ route('front.student.hours') }}">⏳ ساعاتي</a>
                        <a href="{{ route('front.student.weekly-reports') }}">📝 تقاريري</a>
                        <a href="{{ route('front.student.certificate') }}">🎓 الشهادة</a>
                        <a href="{{ route('front.student.massege') }}">💬 الرسائل</a>
                        <hr>
    ...
    <nav class="student-pages-nav">
        <div class="student-pages-container">
            ...
            <a href="{{ route('front.student.massege') }}" data-title="الرسائل">💬 الرسائل</a>
    ...
    <footer class="main-footer">
        <div class="footer-container">
            ...
            <div class="footer-col">
                <h3>روابط سريعة</h3>
                <ul>
                    <li><a href="{{ route('front.home.index') }}">الرئيسية</a></li>
