  ...
  <div class="opportunity-grid">
    ...
    <div class="opportunity-card">
      ...
      <div class="card-image">
        <img src="{{ asset('internship/img/web.png') }}" alt="تطوير ويب">
      </div>

      <div class="card-body">
        <h3>تطوير ويب</h3>
        <p>شركة ABC | 10 مقاعد</p>
        <span>علوم الحاسوب</span>
        <a href="{{ route('front.home.opportunity-details') }}" class="view-btn">
          عرض التفاصيل
        </a>
      </div>
    ...
    <div class="opportunity-card">
      ...
      <div class="card-image">
        <img src="{{ asset('internship/img/cyber.jpg') }}" alt="أمن المعلومات">
      </div>

      <div class="card-body">
        <h3>أمن المعلومات</h3>
        <p>شركة XYZ | 5 مقاعد</p>
        <span>هندسة أمن المعلومات</span>
        <a href="{{ route('front.home.opportunity-details') }}" class="view-btn">
          عرض التفاصيل
        </a>
      </div>
