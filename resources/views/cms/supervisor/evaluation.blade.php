            ...
            <div class="evaluation-card form-card">
                ...
                <form class="evaluation-form">
                    <div class="form-group">
                        ...
                        <select id="evalStudent">
                            <option value="إسراء كسكين">إسراء كسكين</option>
                            <option value="سارة أحمد">سارة أحمد</option>
                            <option value="هبة علي">هبة علي</option>
                            <option value="دعاء عمر">دعاء عمر</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label for="evalRate">التقييم العام</label>
                        <select id="evalRate">
                    ...
                    <div class="scores-grid">
                        <div class="form-group">
                            <label for="evalCommit">الالتزام</label>
                            <input type="number" id="evalCommit" min="1" max="10" value="8">
                        </div>

                        <div class="form-group">
                            <label for="evalSkills">المهارات</label>
                            <input type="number" id="evalSkills" min="1" max="10" value="8">
                        </div>

                        <div class="form-group">
                            <label for="evalComm">التواصل</label>
                            <input type="number" id="evalComm" min="1" max="10" value="8">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="evalNotes">ملاحظات المشرف</label>
                        <textarea id="evalNotes" rows="5" placeholder="اكتبي ملاحظاتك هنا..."></textarea>
                    </div>

                    <div class="evaluation-actions">
                        <button type="button" class="save-eval-btn" id="saveEval">💾 حفظ التقييم</button>
                    </div>
                </form>
            </div>
