...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-dark">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('cms.supervisor.estudents') }}" class="nav-link text-white">الطلاب</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('cms.supervisor.imessages') }}" class="nav-link text-white">الرسائل</a>
            </li>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">لوحة المشرف</a>
                </div>
            </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column admin-sidebar-menu" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('cms.supervisor.estudents') }}" class="nav-link {{ request()->routeIs('cms.supervisor.estudents') ? 'active' : '' }}">
                  ...
                  <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('cms.supervisor.imessages') }}" class="nav-link {{ request()->routeIs('cms.supervisor.imessages') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('cms.supervisor.change-password') }}" class="nav-link">
