...
التدريب: Back-End Laravel

</div>

<div class="info">

تاريخ البداية: 2026-02-01
...
<a href="{{ route('cms.company.internsprofile') }}"
   class="btn btn-primary">
   عرض الملف
</a>

<button class="btn btn-remove"
onclick="removeIntern(this)">
...
<a href="{{ route('front.student.profile') }}"
   class="btn btn-primary">
   عرض الملف
</a>
...
function removeIntern(btn){

const card = btn.closest(".intern-card");

const confirmDelete = confirm("هل تريد إنهاء تدريب هذا الطالب؟");
