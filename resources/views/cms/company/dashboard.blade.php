...
<main class="company-dashboard">
  ...
  <section class="dash-welcome">
    ...
    <div class="welcome-actions">
      <a href="{{ route('cms.Company.opportunity-create') }}" class="btn-primary">➕ إنشاء فرصة جديدة</a>
      <a href="{{ route('cms.Company.applications')}}" class="btn-outline">📌 عرض الطلبات</a>
    </div>
  </section>
  ...
  <section class="dash-grid">
    ...
    <div class="dash-box">
      <div class="dash-box-header">
        <h3>📌 آخر الطلبات</h3>
        <a href="{{ route('cms.Company.applications') }}" class="dash-link">عرض الكل</a>
      </div>
        ...
        <table class="dash-table">
          ...
          <tbody id="appsTable">
            <tr>
              ...
              <td><a class="table-btn" href="{{ route('cms.Company.applications') }}">عرض</a></td>
            </tr>
            ...
            <tr>
              ...
              <td><span class="status accepted">مقبول</span></td>
              <td><a class="table-btn" href="{{ route('cms.Company.applications') }}">عرض</a></td>
            </tr>
    ...
    <div class="dash-box">
      ...
      <div class="quick-actions">
        ...
        <a href="{{ route('cms.Company.opportunity-create') }}" class="quick-card">
        ...
        <a href="{{ route('cms.Company.opportunities') }}" class="quick-card">
          <div class="quick-icon">📢</div>
          <div class="quick-info">
            <h4>إدارة الفرص</h4>
