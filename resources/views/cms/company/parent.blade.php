...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-dark">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('cms.Company.profile') }}" class="nav-link text-white">البروفايل</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('cms.Company.opportunities') }}" class="nav-link text-white">فرص التدريب</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('cms.Company.opportunity-create') }}" class="nav-link text-white">انشاء فرصة</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('cms.Company.applications') }}" class="nav-link text-white">الطلبات</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('cms.Company.notifications') }}" class="nav-link text-white">الإشعارات</a>
            </li>
        </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">مدير الشركة</a>
                </div>
            </div>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column admin-sidebar-menu" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview {{ request()->routeIs('admin.dashboard*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview" style="{{ request()->routeIs('cms.Company.dashboard') ? 'display:block;' : 'display:none;' }}">
                            <li class="nav-item">
                                <a href="{{ route('cms.Company.dashboard') }}" class="nav-link {{ request()->routeIs('cms.Company.dashboard') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('cms.Company.profile') }}" class="nav-link {{ request()->routeIs('cms.Company.profile') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('cms.Company.opportunities') }}" class="nav-link {{ request()->routeIs('cms.Company.opportunity') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('cms.Company.opportunity-create') }}" class="nav-link {{ request()->routeIs('cms.Company.opportunity-create') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('cms.Company.applications') }}" class="nav-link {{ request()->routeIs('cms.Company.applications') ? 'active' : '' }}">
...
<li class="nav-item">
                        <a href="{{ route('cms.company.internsprofile') }}" class="nav-link {{ request()->routeIs('cms.Company.evaluation') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-bell"></i>
                            <p>الملف الشخصي للمتدرب</p>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('cms.Company.notifications') }}" class="nav-link {{ request()->routeIs('cms.Company.notifications') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-bell"></i>
                            <p>الاشعارات</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('cms.Company.profile') }}" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('cms.company.change-password') }}" class="nav-link">
