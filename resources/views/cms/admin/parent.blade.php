...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-dark">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('admin.students') }}" class="nav-link text-white">الطلاب</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('admin.companies') }}" class="nav-link text-white">الشركات</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('admin.supervisors') }}" class="nav-link text-white">المشرفون</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column admin-sidebar-menu" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.supervisors') }}" class="nav-link {{ request()->routeIs('admin.supervisors') ? 'active' : '' }}">
...
<script src="{{ asset('cms/dist/js/cms/student.js') }}"></script>
<script src="{{ asset('cms/dist/js/cms/admin.js') }}"></script>
