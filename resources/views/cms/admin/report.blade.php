                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover table-bordered text-center">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>تقرير متابعة تدريب الطالب أحمد</td>
                                <td>تقارير الطلاب</td>
                                <td>شركة المستقبل</td>
                                <td>2026-04-07</td>
                                <td><span class="badge badge-success">مكتمل</span></td>
                                <td>
                                    <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#reportModal">
                            ...
                            <tr>
                                <td>2</td>
                                <td>تقرير ساعات التدريب لشهر مارس</td>
                            ...
                            <tr>
                                <td>3</td>
                                <td>تقرير تقييم الشركات المستضيفة</td>
                                <td>تقارير الشركات</td>
                                <td>قسم التدريب</td>
                                <td>2026-04-02</td>
                                <td><span class="badge badge-secondary">مؤرشف</span></td>
                                <td>
                                    <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#reportModal">
                                        <i class="fas fa-eye"></i> عرض
                                    </button>
